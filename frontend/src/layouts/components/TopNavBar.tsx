    ...
    return (
        <nav className="fixed top-0 left-0 right-0 z-10 bg-black border-gray-800">
            <div className="flex flex-wrap items-center justify-start mx-auto p-4 space-x-4">
                <a href="https://flowbite.com/" className="flex items-center space-x-3 rtl:space-x-reverse mr-20">
                    <img src="https://storage.googleapis.com/pr-newsroom-wp/1/2023/05/Spotify_Primary_Logo_RGB_Green.png" className="h-8 mr-5" alt="Flowbite Logo" />
                    <span className="self-center text-2xl font-semibold whitespace-nowrap text-white">Spootify</span>
                </a>
                ...
                <div className="hidden w-full md:block md:w-auto ml-auto mr-9">
                    <ul className="font-medium flex flex-col p-4 md:p-0 mt-4  rounded-lg bg-black md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0">
                        <li><a href="#" className="block py-2 px-3 text-white hover:bg-gray-700 md:hover:bg-transparent md:hover:text-blue-500">Login</a></li>
                        <li><a href="#" className="block py-2 px-3 text-white hover:bg-gray-700 md:hover:bg-transparent md:hover:text-blue-500">Sign Up</a></li>
                    </ul>
                </div>
            </div>
        </nav>
